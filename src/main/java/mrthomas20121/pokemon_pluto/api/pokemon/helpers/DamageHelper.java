...
public class DamageHelper {
    ...
    public static double getDamageFormula(PokemonData pkmn, PokemonData target, Move move) {
        double size = 1;
        ...
        double type_effectiveness = PokemonHelper.getEffectiveness(move.getType(), target.get()).getMultiplicator(); // Effectiveness based on the move and the target type
